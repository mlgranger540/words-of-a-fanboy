...
[This guide](https://www.xjavascript.com/blog/position-sticky-scrollable-when-longer-than-viewport/) then helped when trying to add a scrollbar to the sticky sidebar so the content isn't cut off when it goes outside the viewport.
